...
# Dataset paths from Hugging Face Hub
Xtrain_path = "hf://datasets/akarora93/predict-customer-purchase/Xtrain.csv"
Xtest_path = "hf://datasets/akarora93/predict-customer-purchase/Xtest.csv"
ytrain_path = "hf://datasets/akarora93/predict-customer-purchase/ytrain.csv"
ytest_path = "hf://datasets/akarora93/predict-customer-purchase/ytest.csv"
...
param_grid = {
    ...
    'xgbclassifier__reg_lambda': [0.4, 0.6, 0.8],
}
...
with mlflow.start_run():
    ...
    model_path = "best_predict_customer_purchase_model_v1.joblib"
    ...
    api.upload_file(
        path_or_fileobj="best_predict_customer_purchase_model_v1.joblib",
        path_in_repo="best_predict_customer_purchase_model_v1.joblib",
        repo_id=repo_id,
        repo_type=repo_type,
    )
